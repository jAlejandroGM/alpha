...
from src.models import db, User, Student, Teacher, GradeLevel, Course, Schedule, Enrollment, Payment, datetime, Attendance, Grade
...
from src.models import db, User
from src.api.mail_config import mail, serializer
import os
