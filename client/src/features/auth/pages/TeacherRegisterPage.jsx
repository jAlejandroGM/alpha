    ...
    <div className="background-container">
      {showConfirmation ? (
        <div className="login-signup-form position-absolute top-50 start-50 translate-middle border rounded-3 p-4">
          <div className="text-center">
            ...
            <div className="d-flex flex-column gap-2">
              <p className="mb-0">
                ¡Tu registro como profesor ha sido exitoso!
              </p>
              <p className="text-muted small">
                Tu información está siendo revisada. Una vez aprobada, podrás
                acceder a la plataforma. Este proceso suele tardar menos de 24
                horas.
              </p>
            </div>
        ...
        <div className="login-signup-form position-absolute top-50 start-50 translate-middle border rounded-3 p-3 p-md-4">
          ...
          <form
            className="login-width signup-form mx-auto"
            onSubmit={handleSubmit(procesarDatos)}
          >
            <div className="row g-3 mb-3">
              ...
              <div className="col-12 col-lg-6">
                <input
                  type="text"
                  id="location"
                  placeholder="Ejemplo: Coronel Pereira 12, Las Condes, Chile"
                  className={
                  ...
                  {...register("location", {
                    ...
                    pattern: {
                      value: /^[A-Za-z0-9\s,]+$/i,
                      message:
                        'La dirección debe contener solo letras, números o ",".',
                    },
                  })}
                />
                <div className="invalid-feedback">
              ...
              <div className="col-12 col-lg-6">
                <select
                  id="course_id"
                  className={
                    "form-control " + (errors.course_id ? "is-invalid" : "")
                  }
                  {...register("course_id", {
                    required: "Porfavor seleccione una asignatura",
                  })}
                >
                ...
                <input
                  ...
                  {...register("password", {
                    ...
                    pattern: {
                      value: /^[a-zA-z0-9\-\.\@\!]+$/i,
                      message:
                        "El valor debe contener letras y números y los símbolos .,-,@,!",
                    },
                  })}
                />
                <div className="invalid-feedback">
